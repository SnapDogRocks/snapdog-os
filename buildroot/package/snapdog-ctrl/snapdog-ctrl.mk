...
define SNAPDOG_CTRL_INSTALL_INIT_SYSTEMD
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_SNAPDOG_PATH)/package/snapdog-ctrl/snapdog-boot-remount-rw.service \
		$(TARGET_DIR)/usr/lib/systemd/system/snapdog-boot-remount-rw.service
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_SNAPDOG_PATH)/package/snapdog-ctrl/snapdog-boot-remount-ro.service \
		$(TARGET_DIR)/usr/lib/systemd/system/snapdog-boot-remount-ro.service
